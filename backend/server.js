...
import adminZenithgridLicensesRoutes from './routes/admin/zenithgridLicenses.js';
import zenithgridLicensingRoutes from './routes/zenithgridLicensing.js';
...
app.use('/api/admin/zenithgrid-licenses', adminLimiter, adminIPWhitelist, doubleCsrfProtection, adminZenithgridLicensesRoutes); // Admin ZenithGrid license issuance/revocation
...
app.use('/api/public/zenithgrid', generalLimiter, zenithgridLicensingRoutes); // ZenithGrid license activation/heartbeat (unauthenticated, machine client)
