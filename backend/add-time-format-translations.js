...
async function addTranslations() {
  ...
  try {
    console.log('Adding time format preference translation keys...');
    ...
    const translations = [
      {
        key: 'settings.profile.timeFormat',
        en: 'Time Format',
        es: 'Formato de Hora'
      },
      {
        key: 'settings.profile.timeFormat12h',
        en: '12-hour (AM/PM)',
        es: '12 horas (AM/PM)'
      },
      {
        key: 'settings.profile.timeFormat24h',
        en: '24-hour',
        es: '24 horas'
      }
    ];
