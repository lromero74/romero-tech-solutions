...
| Stage | Theme | Effort | Risk | Independent? |
|---|---|---|---|---|
| 1 | Tiny collectors (8 health checks) | 1–2 wk per check, ~6 wk total | Low | Yes |
| 2 | Trend/forecast/anomaly | 3–4 wk | Medium (data volume) | Yes |
