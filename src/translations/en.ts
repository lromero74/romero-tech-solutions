export const enTranslations = {
  ...
  'pricing.hero.subtitle': 'Managed IT plans for predictable support, plus transparent hourly rates when you only need help occasionally.',
  ...
  'pricing.managed.title': 'Managed IT Support Plans',
  'pricing.managed.subtitle': 'Predictable monthly support for small businesses that want fewer surprises, stronger security basics, and a local partner who knows their systems.',
  'pricing.managed.perUser': 'per user / month',
  'pricing.managed.recommended': 'Most Popular',
  'pricing.managed.essentials.title': 'RTS Essentials',
  'pricing.managed.essentials.subtitle': 'For very small offices that need dependable help with everyday technology.',
  'pricing.managed.essentials.minimum': '$500/mo minimum',
  'pricing.managed.essentials.features': 'Business-hours remote support|Device monitoring and patching|Email and account administration|Endpoint protection guidance|Basic backup checks',
  'pricing.managed.managed.title': 'RTS Managed',
  'pricing.managed.managed.subtitle': 'The best fit for most 3-10 seat businesses that want proactive IT support.',
  'pricing.managed.managed.minimum': '$750/mo minimum',
  'pricing.managed.managed.features': 'Everything in Essentials|Priority support and vendor coordination|Microsoft 365 or Google Workspace administration|Quarterly technology review|Backup and security posture review',
  'pricing.managed.secure.title': 'RTS Secure Managed',
  'pricing.managed.secure.subtitle': 'For firms with sensitive client, financial, legal, health, or nonprofit program data.',
  'pricing.managed.secure.minimum': '$1,000/mo minimum',
  'pricing.managed.secure.features': 'Everything in Managed|Enhanced security baseline|MFA and account-hardening support|Policy and cyber-insurance readiness guidance|Higher-touch planning and reporting',
  'pricing.managed.nonprofit.title': 'Nonprofit and community organization pricing',
  'pricing.managed.nonprofit.description': 'Qualified nonprofits and mission-driven community organizations may receive 15-20% off managed plans. Most nonprofit managed-support engagements start around $650/month depending on seat count and scope.',
  ...
  'pricing.tiers.premium.time': 'Early morning, evening, and Saturday support windows',
  'pricing.tiers.premium.description': 'Enhanced rate for early morning, evening, and Saturday support windows',
  ...
  'pricing.tiers.emergency.time': 'All other times',
  ...
  'pricing.disclaimer': '* Rates are subject to change. Rate tier categories are based on Pacific Time scheduling windows. Managed plans do not include project work, hardware, software licensing, or after-hours emergency labor unless stated in the agreement.',

  'pricing.cta.title': 'Ready to Get Started?',
  'pricing.cta.subtitle': 'Contact us today for a free consultation and we will help you choose between managed support and hourly service based on your needs.',
