export const esTranslations = {
  ...
  'pricing.hero.subtitle': 'Planes de TI administrada para soporte predecible, más tarifas por hora transparentes cuando solo necesita ayuda ocasional.',
  ...
  'pricing.managed.title': 'Planes de Soporte de TI Administrada',
  'pricing.managed.subtitle': 'Soporte mensual predecible para pequeñas empresas que quieren menos sorpresas, bases de seguridad más sólidas y un socio local que conozca sus sistemas.',
  'pricing.managed.perUser': 'por usuario / mes',
  'pricing.managed.recommended': 'Más Popular',
  'pricing.managed.essentials.title': 'RTS Essentials',
  'pricing.managed.essentials.subtitle': 'Para oficinas muy pequeñas que necesitan ayuda confiable con la tecnología diaria.',
  'pricing.managed.essentials.minimum': 'Mínimo $500/mes',
  'pricing.managed.essentials.features': 'Soporte remoto en horario laboral|Monitoreo y parches de dispositivos|Administración de correo y cuentas|Guía de protección de endpoints|Revisiones básicas de respaldo',
  'pricing.managed.managed.title': 'RTS Managed',
  'pricing.managed.managed.subtitle': 'La mejor opción para la mayoría de empresas de 3-10 usuarios que quieren soporte de TI proactivo.',
  'pricing.managed.managed.minimum': 'Mínimo $750/mes',
  'pricing.managed.managed.features': 'Todo lo de Essentials|Soporte prioritario y coordinación con proveedores|Administración de Microsoft 365 o Google Workspace|Revisión tecnológica trimestral|Revisión de respaldo y postura de seguridad',
  'pricing.managed.secure.title': 'RTS Secure Managed',
  'pricing.managed.secure.subtitle': 'Para firmas con datos sensibles de clientes, finanzas, legales, salud o programas sin fines de lucro.',
  'pricing.managed.secure.minimum': 'Mínimo $1,000/mes',
  'pricing.managed.secure.features': 'Todo lo de Managed|Base de seguridad mejorada|Soporte para MFA y fortalecimiento de cuentas|Guía para políticas y preparación de seguro cibernético|Planificación e informes de mayor contacto',
  'pricing.managed.nonprofit.title': 'Precios para organizaciones sin fines de lucro y comunitarias',
  'pricing.managed.nonprofit.description': 'Las organizaciones calificadas sin fines de lucro y comunitarias pueden recibir 15-20% de descuento en planes administrados. La mayoría de compromisos administrados para nonprofits empiezan alrededor de $650/mes según usuarios y alcance.',
  ...
  'pricing.tiers.premium.time': 'Madrugada, tarde/noche y ventanas de sábado',
  'pricing.tiers.premium.description': 'Tarifa mejorada para madrugada, tarde/noche y ventanas de sábado',
  ...
  'pricing.tiers.emergency.time': 'Todos los demás horarios',
  ...
  'pricing.disclaimer': '* Las tarifas están sujetas a cambios. Las categorías de niveles de tarifa se basan en ventanas de programación en hora del Pacífico. Los planes administrados no incluyen proyectos, hardware, licencias de software ni trabajo de emergencia fuera de horario salvo que el acuerdo lo indique.',

  'pricing.cta.title': '¿Listo para Comenzar?',
  'pricing.cta.subtitle': 'Contáctenos hoy para una consulta gratuita y le ayudaremos a elegir entre soporte administrado y servicio por hora según sus necesidades.',
