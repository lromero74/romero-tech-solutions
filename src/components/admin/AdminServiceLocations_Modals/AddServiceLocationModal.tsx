                ...
                <div className="md:col-span-2">
                  ...
                  {loadingBusinesses ? (
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 pr-10 border ${themeClasses.border.primary} rounded-md ${themeClasses.bg.primary} ${themeClasses.text.primary} appearance-none bg-no-repeat bg-right focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
                      style={{
