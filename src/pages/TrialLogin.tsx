  ...
  useEffect(() => {
    const performMagicLinkLogin = async () => {
      try {
        ...
        // Call the trial magic-link login endpoint
        const apiBaseUrl = import.meta.env.VITE_API_BASE_URL || 'http://localhost:3001/api';
        const response = await fetch(`${apiBaseUrl}/auth/trial-magic-login`, {
          method: 'POST',
          headers: {
        ...
        console.error('Error during trial magic-link login:', error);
        setStatus('error');
  ...
  const renderLoadingState = () => (
    <div className="text-center">
      ...
      <p className="text-blue-200">
        Please wait while we set up your trial dashboard...
      </p>
    </div>
  );
      ...
      <div className="bg-green-500/20 backdrop-blur-sm border border-green-300/30 rounded-lg p-6">
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm text-green-200">
            <p className="font-medium mb-2">Your Trial Includes:</p>
    ...
    <div className="text-center">
      ...
      <div className="space-y-4">
        <p className="text-blue-200 text-sm">
          Please return to your RTS Agent and generate a new login link.
        </p>
        <button
